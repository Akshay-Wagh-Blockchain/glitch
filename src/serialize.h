...
#ifndef GLITCH_SERIALIZE_H
#define GLITCH_SERIALIZE_H
...
static const unsigned int MAX_SIZE = 0x10000000; // Glitch: Increase max serialized size to 256mb
