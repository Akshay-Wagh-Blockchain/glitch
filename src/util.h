 ...
 */
#ifndef GLITCH_UTIL_H
#define GLITCH_UTIL_H
...
extern const char * const GLITCH_CONF_FILENAME;
extern const char * const GLITCH_PID_FILENAME;
...
{
    std::string s = strprintf("glitch-%s", name);
