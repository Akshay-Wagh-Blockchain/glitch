    ...
    mapper(0)
{
    ...
    ui->glitchAtStartup->setToolTip(ui->glitchAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->glitchAtStartup->setText(ui->glitchAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->glitchAtStartup, OptionsModel::StartAtStartup);
