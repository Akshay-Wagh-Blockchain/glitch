...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " glitch-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  glitch-tx [options] <hex-tx> [commands]  Update hex-encoded glitch transaction\n" +
            "or:     glitch-tx [options] -create [commands]   Create hex-encoded glitch transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded glitch transaction
