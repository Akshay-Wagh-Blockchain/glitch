...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GLITCH");
    case mBTC: return QString("mGLITCH");
    case uBTC: return QString::fromUtf8("μGLITCH (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Glitchs");
    case mBTC: return QString("Milli-Glitchs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Glitchs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
