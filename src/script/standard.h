...
#ifndef GLITCH_SCRIPT_STANDARD_H
#define GLITCH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a glitch address
 */
...
#endif // GLITCH_SCRIPT_STANDARD_H
