...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/glitch/glitch/pull/10340, but that change has been
    // postponed until after https://github.com/glitch/glitch/pull/10244 to
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign, CAmount nGasFee, bool hasSender)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-glitch-address
 ...
 * https://glitchtalk.org/?topic=54527, or
 * https://github.com/glitch/glitch/pull/1393.
 */
...
void CWallet::StakeGlitchs(bool fStake, CConnman* connman)
{
    ::StakeGlitchs(fStake, this, connman, stakeThread);
}
