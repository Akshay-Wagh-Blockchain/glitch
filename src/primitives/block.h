...
#ifndef GLITCH_PRIMITIVES_BLOCK_H
#define GLITCH_PRIMITIVES_BLOCK_H
...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // glitch
        hashUTXORoot.SetNull(); // glitch
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //glitch
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //glitch
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //glitch
    {
...
#endif // GLITCH_PRIMITIVES_BLOCK_H
