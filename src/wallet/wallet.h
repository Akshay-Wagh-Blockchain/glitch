...
#ifndef GLITCH_WALLET_WALLET_H
#define GLITCH_WALLET_WALLET_H
...
public:
     ...
     * on this glitch node, and set to 0 for transactions that were created
...
private:
    ...
    void StakeGlitchs(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking glitchs */
    void StartStake(CConnman* connman) { StakeGlitchs(true, connman); }

    /* Stop staking glitchs */
    void StopStake() { StakeGlitchs(false, 0); }
