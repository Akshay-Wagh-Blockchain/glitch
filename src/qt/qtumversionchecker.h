#ifndef GLITCHVERSIONCHECKER_H
#define GLITCHVERSIONCHECKER_H

#include <QObject>

#define GLITCH_RELEASES "https://github.com/glitchproject/glitch/releases"
...
class GlitchVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit GlitchVersionChecker(QObject *parent = 0);
    ~GlitchVersionChecker();
