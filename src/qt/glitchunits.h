...
#ifndef GLITCH_QT_GLITCHUNITS_H
#define GLITCH_QT_GLITCHUNITS_H
...
public:
    ...
    /** Bitcoin units.
      @note Source: https://en.glitch.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
