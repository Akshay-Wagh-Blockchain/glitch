#ifndef GLITCH_MINER_H
#define GLITCH_MINER_H
...
unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(CAccountViewCache &view, CTransactionDBCache &txCache, CScriptDBViewCache &scriptCache);
